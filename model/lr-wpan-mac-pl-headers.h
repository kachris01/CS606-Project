...
class CommandPayloadHeader : public Header
{
  public:
    ...
    enum MacCommand
    {
        ...
        LL_DISCOVER_RESP = 0x0d,     //!< LL-Discover Response (RFD true: Tx)
	LL_CONFIG_STATUS = 0x0e,     //!< LL-Configuration Status (RFD true: Tx)
	LL_CONFIG_REQ = 0x0f,        //!< LL-Configuration Request (RFD true: Rx)
	LL_CTS_SHARED_GROUP = 0x10,  //!< LL-CTS shared group (RFD true: Rx)
	LL_REQ_TO_SEND = 0x11,       //!< LL-Request To Send (RFD true: Tx Rx)
	LL_CLEAR_TO_SEND = 0x12,
	DSME_ASSOCIATION_REQ = 0x13,
	DSME_ASSOCIATION_RES = 0x14,
	DSME_GTS_REQ = 0x15,
	DSME_GTS_REPLY = 0x16,
	DSME_GTS_NOTIFY = 0x17,
	DSME_INFO_REQ = 0x18,
	DSME_INFO_REPLY = 0x19,
	DSME_BEACON_ALLOC_NOTIF = 0x1a,
	DSME_BEACON_COLLISIOM_NOTIF = 0x1b,
	DSME_LINK_STATUS_REP = 0x1c,
	AMCA_BEACON_REQ = 0x1d,
	AMCA_HELLO = 0x1e,
	AMCA_CHANNEL_PROBE = 0x1f,
