...
class LrWpanMacHeader : public Header
{
  public:
    ...
    {
        NOADDR = 0,
        SIMPLEADDR = 1,	//CHANGED FROM RESADDR
        SHORTADDR = 2,
        EXTADDR = 3
    };

    /**
     * The key id mode types, see IEEE 802.15.4-2006, Table 96.
     */
    enum KeyIdModeType
    {
        IMPLICIT = 0,
    ...
    /**
     * Get the Sequence Number Suppression of Frame control field
     * \return the Sequence Number Suppression bits
     */
    uint8_t GetFrmCtrlSeqNumSup() const;
    /**
     * Get the IE List Present of Frame control field
     * \return the IE List Present bits
     */
    uint8_t GetFrmCtrlIEListPresent() const;
    /**
    ...
    /**
     * Get the Auxiliary Security Header - Security Control - Frame Counter Sup bit
     * \return the Auxiliary Security Header - Security Control - Frame Counter Sup bits
     */
    uint8_t GetSecCtrlFrmCounterSup() const;
    /**
     * Get the Auxiliary Security Header - Security Control - Frame Counter Size bits
     * \return the Auxiliary Security Header - Security Control - Frame Counter Size bits
     */
    uint8_t GetSecCtrlFrmCounterSize() const;
    /**
    ...
    /**
     * Set the Frame Control field "Sequence Number Suppression" bit
     * \param res Sequence Number Suppression bit
     */
    void SetFrmCtrlSeqNumSup(uint8_t seqnumsup);
    /**
     * Set the Frame Control field "IE List Present" bits
     * \param res IE List Present bit
     */
    void SetFrmCtrlIEListPresent(uint8_t ielistpresent);
    /**
    ...
    /**
     * Set the Security Control field "Frame Counter Sup" bit (1 bit)
     * \param res the "Frame Counter Sup" bit
     */
    void SetSecCtrlFrmCounterSup(uint8_t frmcountersup);
    /**
     * Set the Security Control field "Frame Counter Size" bit (1 bit)
     * \param res the "Frame Counter Size" bit
     */
    void SetSecCtrlFrmCounterSize(uint8_t frmcountersize);
    /**
     * Set the Security Control field "Reserved" bit (1 bit)
     * \param res the "Reserved" bit
     */
  ...
  private:
    ...
    uint8_t m_fctrlSeqNumSup;   //!< Frame Control field Bit 8
    uint8_t m_fctrlIEListPresent;    //!< Frame Control field Bit 9
    ...
    Mac8Address m_addrSimpleDstAddr; //!< Dst Short addr (0 or 2 Octets)
    ...
    Mac8Address m_addrSimpleSrcAddr; //!< Src Short addr (0 or 2 Octets)
    ...
    uint8_t m_secctrlFrmCounterSup; //!< Auxiliary security header - Security Control field - Bit 5
    uint8_t m_secctrlFrmCounterSize; //!< Auxiliary security header - Security Control field - Bit 6
