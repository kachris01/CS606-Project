...
enum FrameControlOptions {
    PAN_ID_SUPPRESSED,
    IES_INCLUDED,
    SEQ_NUMBER_SUPPRESSED,
    NUM_FRAME_CONTROL_OPTIONS  // Number of options, used for array size
};

struct DSME_SuperframeSpec
{
	uint8_t m_multiSuperframeOrder{0};
	uint8_t m_channelDiversityMode{0};
	uint8_t m_GACKflag{0};
	uint8_t m_CAPreductionFlag{0};
	uint8_t m_deferredBeaconFlag{0};
};

struct BeaconBitmap
{
	uint16_t m_sdIndex{0};
	uint16_t m_sdBitmapLength{0};
	uint64_t m_sdBitmap{0}
};

struct HoppingDescriptor
{
	uint8_t m_seqID{0};
	uint8_t m_panCoordinatorBSN{0};
	uint16_t m_channelOffset{0};
	uint8_t m_channelOffsetBitmapLength{0};
	uint64_t m_channelOffsetBitmap{0};
};
...
enum LrWpanMlmeScanType
{
    ...
    MLMESCAN_MULTI_CHANNEL_HELLO = 0x06,
    MLMESCAN_EAS = 0x07
};
...
enum LrWpanMcpsDataConfirmStatus
{
    ...
    IEEE_802_15_4e_ACK_RCVD_NODSN_NOSA = 12
};
...
struct McpsDataRequestParams
{
    ...
    bool m_frameControlOptions[NUM_FRAME_CONTROL_OPTIONS];
    <InformationElement> headerIEList;
    <InformationElement> payloadIEList;
    bool m_sendMultipuprose{false};
};
...
struct McpsDataConfirmParams
{
    ...
    uint8_t m_numBackoffs{0};
    uint64_t m_ackPayload{0};
...
struct MlmeAssociateIndicationParams
{
    ...
    uint64_t m_lowLatencyNetInfo{0};
    uint16_t m_channelOffset{0};
    uint8_t m_hoppingSeqID{0};
};
...
struct MlmeStartRequestParams
{
    ...
    DSME_SuperframeSpec m_DSME_SuperframeSpec;
    BeaconBitmap m_BeaconBitmap;
    HoppingDescriptor m_HoppingDescriptor;
};
...
struct MlmeAssociateRequestParams
{
    ...
    uint64_t m_lowLatencyNetworkInfo{0};
    uint16_t m_channelOffset{0};
    uint8_t m_hoppingSeqID{0};
};
