...
CommandPayloadHeader::Serialize(Buffer::Iterator start) const
{
    ...
    case LL_REQ_TO_SEND:
    	break;
    case LL_CLEAR_TO_SEND:
    	break;
    case DSME_ASSOCIATION_REQ:
    	break;
    case DSME_ASSOCIATION_RES:
    	break;
    case DSME_GTS_REQ:
    	break;
    case DSME_GTS_REPLY:
    ...
    case DSME_BEACON_ALLOC_NOTIF:
    	break;
    case DSME_BEACON_COLLISIOM_NOTIF:
    	break;
    case DSME_LINK_STATUS_REP:
    	break;
    case AMCA_BEACON_REQ:
    	break;
    case AMCA_HELLO:
    	break;
    case AMCA_CHANNEL_PROBE:
    	break;
    case LE_RIT_DATA_REQ:
    	break;
    case CMD_RESERVED:
        break;
    }
...
CommandPayloadHeader::GetCommandFrameType() const
{
    ...
    case 0x0e:
    	return LL_CONFIG_STATUS:
    case 0x0f:
    	return LL_CONFIG_REQ:
    case 0x10:
    	return LL_CTS_SHARED_GROUP:
    case 0x11:
    	return LL_REQ_TO_SEND:
    case 0x12:
    	return LL_CLEAR_TO_SEND:
    case 0x13:
    	return DSME_ASSOCIATION_REQ:
    case 0x14:
    	return DSME_ASSOCIATION_RES:
    case 0x15:
    	return DSME_GTS_REQ:
    case 0x16:
    ...
    case 0x1b:
    	return DSME_BEACON_COLLISIOM_NOTIF:
    case 0x1c:
    	return DSME_LINK_STATUS_REP:
    case 0x1d:
    	return AMCA_BEACON_REQ:
    case 0x1e:
    	return AMCA_HELLO:
    case 0x1f:
    	return AMCA_CHANNEL_PROBE:
    case 0x20:
