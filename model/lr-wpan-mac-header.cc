...
LrWpanMacHeader::LrWpanMacHeader()
{
    ...
    SetFrmCtrlRes(0);         // Initialize the reserved bit to 0
    SetFrmCtrlSeqNumSup(0);         // Initialize the reserved bit to 0
    SetFrmCtrlIEListPresent(0);         // Initialize the reserved bit to 0
...
uint8_t
LrWpanMacHeader::GetFrmCtrlSeqNumSup() const
{
    return (m_fctrlSeqNumSup);
}

uint8_t
LrWpanMacHeader::GetFrmCtrlIEListPresent() const
{
...
Mac8Address
LrWpanMacHeader::GetSimpleDstAddr() const
{
...
Mac8Address
LrWpanMacHeader::GetSimpleSrcAddr() const
{
...
uint8_t
LrWpanMacHeader::GetSecCtrlFrmCounterSup() const
{
    return (m_secctrlFrmCounterSup);
}

uint8_t
LrWpanMacHeader::GetSecCtrlFrmCounterSize() const
{
    return (m_secctrlFrmCounterSize);
}
...
void
LrWpanMacHeader::SetFrmCtrlSeqNumSup(uint8_t seqnumsup)
{
    m_fctrlSeqNumSup = seqnumsup;
}

void
LrWpanMacHeader::SetFrmCtrlIEListPresent(uint8_t ielistpresent)
{
    m_fctrlIEListPresent = ielistpresent;
}
...
void
LrWpanMacHeader::SetSrcAddrFields(uint16_t panId, Mac8Address addr)
{
...
void
LrWpanMacHeader::SetDstAddrFields(uint16_t panId, Mac8Address addr)
{
...
void
LrWpanMacHeader::SetSecCtrlFrmCounterSup(uint8_t frmcountersup)
{
    m_secctrlFrmCounterSup = frmcountersup;
}

void
LrWpanMacHeader::SetSecCtrlFrmCounterSize(uint8_t frmcountersize)
{
    m_secctrlFrmCounterSize = frmcountersize;
}
...
LrWpanMacHeader::Print(std::ostream& os) const
{
    ...
    case SIMPLEADDR:
        os << ", Src Addr Pan ID = " << static_cast<uint16_t>(m_addrSrcPanId)
           << ", m_addrSimpleSrcAddr = " << m_addrSimpleSrcAddr;
        break;
    case SHORTADDR:
        os << ", Src Addr Pan ID = " << static_cast<uint16_t>(m_addrSrcPanId)
